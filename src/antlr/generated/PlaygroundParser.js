// Generated from Playground.g4 by ANTLR 4.8
// jshint ignore: start
var antlr4 = require('antlr4/index');
var PlaygroundVisitor = require('./PlaygroundVisitor').PlaygroundVisitor;

var grammarFileName = "Playground.g4";
...
var literalNames = [ null, "','", "'var'", "'this'", "'@'", "'while'", "'loop'", 
                     "'if'", "'else'", "'end'", null, null, null, "'null'", 
                     "'('", "')'", "'.'", "'='", "'+='", "'-='", "'AND'", 
                     "'OR'", "'NOT'", "'+'", "'-'", "'*'", "'/'", "'%'", 
                     "'=='", "'!='", "'>'", "'<'", "'>='", "'<='", "'=>'", 
                     "'arrowUp'", "'arrowDown'", "'arrowLeft'", "'arrowRight'", 
                     "'space'", "'spaceBar'", "'keyA'", "'keyB'", "'keyC'", 
                     "'keyD'", "'keyE'", "'keyF'", "'keyG'", "'keyH'", "'keyI'", 
                     "'keyJ'", "'keyK'", "'keyL'", "'keyM'", "'keyN'", "'keyO'", 
                     "'keyP'", "'keyQ'", "'keyR'", "'keyS'", "'keyT'", "'keyU'", 
                     "'keyV'", "'keyW'", "'keyX'", "'keyY'", "'keyZ'", "'key0'", 
                     "'key1'", "'key2'", "'key3'", "'key4'", "'key5'", "'key6'", 
                     "'key7'", "'key8'", "'key9'" ];

var symbolicNames = [ null, null, "VAR", "THIS", "AT", "WHILE", "LOOP", 
                      "IF", "ELSE", "END", "BOOL_LITERAL", "NUMBER_LITERAL", 
                      "STRING_LITERAL", "NULL", "LPAREN", "RPAREN", "DOT", 
                      "ASSIGN", "INC", "DEC", "AND", "OR", "NOT", "ADD", 
                      "SUB", "MUL", "DIV", "MOD", "EQUAL", "NOTEQUAL", "GT", 
                      "LT", "GE", "LE", "ARROW", "ARROWUP", "ARROWDOWN", 
                      "ARROWLEFT", "ARROWRIGHT", "SPACE", "SPACEBAR", "KEYA", 
                      "KEYB", "KEYC", "KEYD", "KEYE", "KEYF", "KEYG", "KEYH", 
                      "KEYI", "KEYJ", "KEYK", "KEYL", "KEYM", "KEYN", "KEYO", 
                      "KEYP", "KEYQ", "KEYR", "KEYS", "KEYT", "KEYU", "KEYV", 
                      "KEYW", "KEYX", "KEYY", "KEYZ", "KEY0", "KEY1", "KEY2", 
                      "KEY3", "KEY4", "KEY5", "KEY6", "KEY7", "KEY8", "KEY9", 
                      "WS", "COMMENT", "LINE_COMMENT", "IDENTIFIER" ];

var ruleNames =  [ "parse", "scope", "statement", "varDeclaration", "varAssignment", 
                   "objectPropertyAssignment", "eventStatement", "eventParams", 
                   "conditionalStatement", "loopStatement", "whileStatement", 
                   "expression", "primary", "objectProperty", "objectMethodCall", 
                   "staticMethodCall", "objectIdentifier", "methodParam", 
                   "literal", "constantLiteral", "booleanOperator", "arithmeticOperator", 
                   "relationalOperator", "keyInput" ];
...
PlaygroundParser.prototype.scope = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlaygroundParser.VAR) | (1 << PlaygroundParser.THIS) | (1 << PlaygroundParser.AT) | (1 << PlaygroundParser.WHILE) | (1 << PlaygroundParser.LOOP) | (1 << PlaygroundParser.IF))) !== 0) || _la===PlaygroundParser.IDENTIFIER) {
            this.state = 51;
            this.statement();
            this.state = 56;
            this._errHandler.sync(this);
...
VarAssignmentContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.varAssignment = function() {
    ...
    var localctx = new VarAssignmentContext(this, this._ctx, this.state);
    ...
    try {
        ...
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlaygroundParser.ASSIGN) | (1 << PlaygroundParser.INC) | (1 << PlaygroundParser.DEC))) !== 0))) {
...
ObjectPropertyAssignmentContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.objectPropertyAssignment = function() {
    ...
    var localctx = new ObjectPropertyAssignmentContext(this, this._ctx, this.state);
...
EventStatementContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.eventStatement = function() {
    ...
    var localctx = new EventStatementContext(this, this._ctx, this.state);
...
EventParamsContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.eventParams = function() {
    ...
    var localctx = new EventParamsContext(this, this._ctx, this.state);
...
ElseIfConditionalContext.prototype = Object.create(ConditionalStatementContext.prototype);
...
ThenConditionalContext.prototype = Object.create(ConditionalStatementContext.prototype);
...
ElseCondiitionalContext.prototype = Object.create(ConditionalStatementContext.prototype);
...
UnaryExprContext.prototype.SUB = function() {
...
ComparisonExprContext.prototype.EQUAL = function() {
    return this.getToken(PlaygroundParser.EQUAL, 0);
};

ComparisonExprContext.prototype.NOTEQUAL = function() {
    return this.getToken(PlaygroundParser.NOTEQUAL, 0);
};

ComparisonExprContext.prototype.GT = function() {
    return this.getToken(PlaygroundParser.GT, 0);
};

ComparisonExprContext.prototype.LT = function() {
    return this.getToken(PlaygroundParser.LT, 0);
};

ComparisonExprContext.prototype.GE = function() {
    return this.getToken(PlaygroundParser.GE, 0);
};

ComparisonExprContext.prototype.LE = function() {
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 1:
                    ...
                    this.pushNewRecursionContext(localctx, _startState, PlaygroundParser.RULE_expression);
                    this.state = 145;
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(_la===PlaygroundParser.MUL || _la===PlaygroundParser.DIV)) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 28)) & ~0x1f) == 0 && ((1 << (_la - 28)) & ((1 << (PlaygroundParser.EQUAL - 28)) | (1 << (PlaygroundParser.NOTEQUAL - 28)) | (1 << (PlaygroundParser.GT - 28)) | (1 << (PlaygroundParser.LT - 28)) | (1 << (PlaygroundParser.GE - 28)) | (1 << (PlaygroundParser.LE - 28)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
                ...
                case 4:
                    localctx = new BooleanExprContext(this, new ExpressionContext(this, _parentctx, _parentState));
                    this.pushNewRecursionContext(localctx, _startState, PlaygroundParser.RULE_expression);
                    this.state = 154;
...
ObjectMethodCallContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.objectMethodCall = function() {
    ...
    var localctx = new ObjectMethodCallContext(this, this._ctx, this.state);
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlaygroundParser.THIS) | (1 << PlaygroundParser.BOOL_LITERAL) | (1 << PlaygroundParser.NUMBER_LITERAL) | (1 << PlaygroundParser.STRING_LITERAL) | (1 << PlaygroundParser.LPAREN) | (1 << PlaygroundParser.NOT) | (1 << PlaygroundParser.ADD) | (1 << PlaygroundParser.SUB))) !== 0) || ((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (PlaygroundParser.ARROWUP - 35)) | (1 << (PlaygroundParser.ARROWDOWN - 35)) | (1 << (PlaygroundParser.ARROWLEFT - 35)) | (1 << (PlaygroundParser.ARROWRIGHT - 35)) | (1 << (PlaygroundParser.SPACE - 35)) | (1 << (PlaygroundParser.SPACEBAR - 35)) | (1 << (PlaygroundParser.KEYA - 35)) | (1 << (PlaygroundParser.KEYB - 35)) | (1 << (PlaygroundParser.KEYC - 35)) | (1 << (PlaygroundParser.KEYD - 35)) | (1 << (PlaygroundParser.KEYE - 35)) | (1 << (PlaygroundParser.KEYF - 35)) | (1 << (PlaygroundParser.KEYG - 35)) | (1 << (PlaygroundParser.KEYH - 35)) | (1 << (PlaygroundParser.KEYI - 35)) | (1 << (PlaygroundParser.KEYJ - 35)) | (1 << (PlaygroundParser.KEYK - 35)) | (1 << (PlaygroundParser.KEYL - 35)) | (1 << (PlaygroundParser.KEYM - 35)) | (1 << (PlaygroundParser.KEYN - 35)) | (1 << (PlaygroundParser.KEYO - 35)) | (1 << (PlaygroundParser.KEYP - 35)) | (1 << (PlaygroundParser.KEYQ - 35)) | (1 << (PlaygroundParser.KEYR - 35)) | (1 << (PlaygroundParser.KEYS - 35)) | (1 << (PlaygroundParser.KEYT - 35)) | (1 << (PlaygroundParser.KEYU - 35)) | (1 << (PlaygroundParser.KEYV - 35)) | (1 << (PlaygroundParser.KEYW - 35)) | (1 << (PlaygroundParser.KEYX - 35)) | (1 << (PlaygroundParser.KEYY - 35)) | (1 << (PlaygroundParser.KEYZ - 35)))) !== 0) || ((((_la - 67)) & ~0x1f) == 0 && ((1 << (_la - 67)) & ((1 << (PlaygroundParser.KEY0 - 67)) | (1 << (PlaygroundParser.KEY1 - 67)) | (1 << (PlaygroundParser.KEY2 - 67)) | (1 << (PlaygroundParser.KEY3 - 67)) | (1 << (PlaygroundParser.KEY4 - 67)) | (1 << (PlaygroundParser.KEY5 - 67)) | (1 << (PlaygroundParser.KEY6 - 67)) | (1 << (PlaygroundParser.KEY7 - 67)) | (1 << (PlaygroundParser.KEY8 - 67)) | (1 << (PlaygroundParser.KEY9 - 67)) | (1 << (PlaygroundParser.IDENTIFIER - 67)))) !== 0)) {
            this.state = 177;
            this.methodParam();
            this.state = 182;
            this._errHandler.sync(this);
...
StaticMethodCallContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.staticMethodCall = function() {
    ...
    var localctx = new StaticMethodCallContext(this, this._ctx, this.state);
...
ObjectIdentifierContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.objectIdentifier = function() {
    ...
    var localctx = new ObjectIdentifierContext(this, this._ctx, this.state);
    ...
    try {
        ...
        this.state = 203;
        _la = this._input.LA(1);
        if(!(_la===PlaygroundParser.THIS || _la===PlaygroundParser.IDENTIFIER)) {
...
MethodParamContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.methodParam = function() {
    ...
    var localctx = new MethodParamContext(this, this._ctx, this.state);
...
LiteralContext.prototype.ADD = function() {
    return this.getToken(PlaygroundParser.ADD, 0);
};

LiteralContext.prototype.SUB = function() {
    return this.getToken(PlaygroundParser.SUB, 0);
};
...
ConstantLiteralContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
PlaygroundParser.prototype.constantLiteral = function() {
    ...
    var localctx = new ConstantLiteralContext(this, this._ctx, this.state);
...
PlaygroundParser.prototype.booleanOperator = function() {
    ...
    try {
        ...
        this.state = 221;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlaygroundParser.AND) | (1 << PlaygroundParser.OR) | (1 << PlaygroundParser.NOT))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
PlaygroundParser.prototype.arithmeticOperator = function() {
    ...
    try {
        ...
        this.state = 223;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlaygroundParser.ADD) | (1 << PlaygroundParser.SUB) | (1 << PlaygroundParser.MUL) | (1 << PlaygroundParser.DIV) | (1 << PlaygroundParser.MOD))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
PlaygroundParser.prototype.keyInput = function() {
    ...
    var localctx = new KeyInputContext(this, this._ctx, this.state);
    ...
    try {
        ...
        this.state = 227;
        _la = this._input.LA(1);
        if(!(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (PlaygroundParser.ARROWUP - 35)) | (1 << (PlaygroundParser.ARROWDOWN - 35)) | (1 << (PlaygroundParser.ARROWLEFT - 35)) | (1 << (PlaygroundParser.ARROWRIGHT - 35)) | (1 << (PlaygroundParser.SPACE - 35)) | (1 << (PlaygroundParser.SPACEBAR - 35)) | (1 << (PlaygroundParser.KEYA - 35)) | (1 << (PlaygroundParser.KEYB - 35)) | (1 << (PlaygroundParser.KEYC - 35)) | (1 << (PlaygroundParser.KEYD - 35)) | (1 << (PlaygroundParser.KEYE - 35)) | (1 << (PlaygroundParser.KEYF - 35)) | (1 << (PlaygroundParser.KEYG - 35)) | (1 << (PlaygroundParser.KEYH - 35)) | (1 << (PlaygroundParser.KEYI - 35)) | (1 << (PlaygroundParser.KEYJ - 35)) | (1 << (PlaygroundParser.KEYK - 35)) | (1 << (PlaygroundParser.KEYL - 35)) | (1 << (PlaygroundParser.KEYM - 35)) | (1 << (PlaygroundParser.KEYN - 35)) | (1 << (PlaygroundParser.KEYO - 35)) | (1 << (PlaygroundParser.KEYP - 35)) | (1 << (PlaygroundParser.KEYQ - 35)) | (1 << (PlaygroundParser.KEYR - 35)) | (1 << (PlaygroundParser.KEYS - 35)) | (1 << (PlaygroundParser.KEYT - 35)) | (1 << (PlaygroundParser.KEYU - 35)) | (1 << (PlaygroundParser.KEYV - 35)) | (1 << (PlaygroundParser.KEYW - 35)) | (1 << (PlaygroundParser.KEYX - 35)) | (1 << (PlaygroundParser.KEYY - 35)) | (1 << (PlaygroundParser.KEYZ - 35)))) !== 0) || ((((_la - 67)) & ~0x1f) == 0 && ((1 << (_la - 67)) & ((1 << (PlaygroundParser.KEY0 - 67)) | (1 << (PlaygroundParser.KEY1 - 67)) | (1 << (PlaygroundParser.KEY2 - 67)) | (1 << (PlaygroundParser.KEY3 - 67)) | (1 << (PlaygroundParser.KEY4 - 67)) | (1 << (PlaygroundParser.KEY5 - 67)) | (1 << (PlaygroundParser.KEY6 - 67)) | (1 << (PlaygroundParser.KEY7 - 67)) | (1 << (PlaygroundParser.KEY8 - 67)) | (1 << (PlaygroundParser.KEY9 - 67)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
